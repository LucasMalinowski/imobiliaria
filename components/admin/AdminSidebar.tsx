    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <form action={signOut}>
          <button
            type="submit"
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-white/60 hover:text-red-400 hover:bg-red-500/10 transition-all duration-200 text-sm"
          >
